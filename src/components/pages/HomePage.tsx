...
import { Star, Phone, ArrowRight, CheckCircle2, MapPin, Award, Brush, Home, PaintBucket } from 'lucide-react';
...
// Placeholder for when no photo is provided
function PhotoPlaceholder({ label, className = '' }: { label?: string; className?: string }) {
  return (
    <div className={`bg-gradient-to-br from-primary/90 to-primary flex items-center justify-center ${className}`}>
      {label && (
        <span className="font-paragraph text-xs uppercase tracking-widest text-white/30">{label}</span>
      )}
    </div>
  );
}
...
function StatCounter({ value, label }: { value: string; label: string }) {
  ...
  return (
    ...
    >
      <span className="font-heading text-4xl lg:text-5xl text-white leading-none">
        {isNumeric ? `${count}${suffix}` : value}
      </span>
      <span className="font-paragraph text-xs uppercase tracking-[0.2em] text-white/45 mt-2">{label}</span>
    </motion.div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        {/* Background: photo when available, rich gradient placeholder otherwise */}
        ...
        <motion.div
          ...
          className="absolute left-0 right-0 top-[55%] h-px bg-accent-gold/20 origin-left"
        />
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto pt-20">
          <motion.p
            ...
            transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
            className="font-paragraph text-xs uppercase tracking-[0.4em] text-accent-gold font-semibold mb-6"
          >
          ...
          <motion.h1
            ...
            className="font-heading text-6xl sm:text-7xl lg:text-8xl xl:text-9xl text-white leading-[0.93] mb-6"
          >
            Painting You Can<br />
            <span className="italic text-accent-gold">Count On.</span>
          </motion.h1>
          ...
          <motion.div
            ...
            className="origin-center h-0.5 w-20 bg-accent-gold mx-auto mb-8"
          />
          ...
          >
            ...
            <span className="font-paragraph text-xs text-white/45 uppercase tracking-widest">5-Star Rated on Google</span>
          </motion.div>
        </div>
      ...
      <section className="bg-primary">
        <div className="max-w-[100rem] mx-auto px-6 lg:px-16 py-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-0 lg:divide-x lg:divide-white/10">
            {stats.map((stat, i) => (
              <div key={i} className="flex justify-center" style={{ transitionDelay: `${i * 0.1}s` }}>
      ...
      <section className="py-24 lg:py-32 bg-background">
        <div className="max-w-[100rem] mx-auto px-6 lg:px-16">
          ...
          {/* Service cards: horizontal row with left border accent */}
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              <motion.div
                ...
                className="group relative bg-muted hover:bg-primary rounded-xl p-7 transition-all duration-400 overflow-hidden cursor-default"
              >
                {/* Hover glow */}
                <div
                  ...
                  style={{ backgroundImage: 'radial-gradient(ellipse 70% 60% at 10% 10%, rgba(200,146,42,0.1) 0%, transparent 70%)' }}
                />

                {/* Icon */}
                <div className="w-10 h-10 rounded-lg bg-accent-gold/15 group-hover:bg-accent-gold/20 flex items-center justify-center text-accent-gold mb-5 transition-colors duration-300">
                ...
                <p className="font-paragraph text-sm text-secondary group-hover:text-white/65 leading-relaxed transition-colors duration-300">
        ...
        <div className="max-w-[100rem] mx-auto px-6 lg:px-16">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              {/* Amber accent block behind image */}
              <div className="absolute -bottom-5 -right-5 w-28 h-28 bg-accent-gold/20 rounded-xl -z-10" />
              <div className="absolute -top-5 -left-5 w-16 h-16 border-2 border-primary/20 rounded-xl -z-10" />
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="flex flex-col gap-0">
                {[
                  ...
                  { title: 'Locally based in Greenville', desc: 'Serving the Upstate for over a decade. We live in this community and take pride in every job.' },
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-16 text-center relative z-10">
          {reviews[0] && (
            ...
            >
              ...
              <p className="font-paragraph text-sm font-semibold uppercase tracking-widest text-white/45">
      ...
      >
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          ...
          <motion.p
            ...
            className="font-paragraph text-base text-white/60 mb-10"
          >
            No pressure. Just a straightforward estimate, clear communication, and work you can stand behind.
          </motion.p>
          <motion.div
