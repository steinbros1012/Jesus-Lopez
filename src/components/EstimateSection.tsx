      ...
      <div className="max-w-[100rem] mx-auto px-6 lg:px-16">
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="font-paragraph text-base text-white/55 mb-10 leading-relaxed">
              Fast response, clear pricing, and quality work for homes across Greenville, Greer, Simpsonville, Mauldin, Spartanburg, Anderson, Easley, and nearby Upstate South Carolina communities.
            </p>
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <div key={item} className="flex items-center gap-3">
                  ...
                  <span className="font-paragraph text-sm text-white/55">{item}</span>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl p-8 lg:p-10 shadow-[0_16px_60px_rgba(0,0,0,0.12)]"
          >
            {isSubmitted ? (
              <div className="text-center py-10">
                <div className="w-14 h-14 mx-auto mb-5 bg-primary rounded-full flex items-center justify-center">
                  <CheckCircle2 className="w-7 h-7 text-white" />
                </div>
                <h3 className="font-heading text-3xl text-foreground mb-3">Thank You!</h3>
                <p className="font-paragraph text-sm text-secondary">We received your request and will be in touch shortly.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Select value={formData.serviceType} onValueChange={(v) => handleChange('serviceType', v)} required>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Drywall / Patch Repair">Drywall / Patch Repair</SelectItem>
                      <SelectItem value="Pressure Washing">Pressure Washing</SelectItem>
                      <SelectItem value="Trim & Detail Work">Trim &amp; Detail Work</SelectItem>
                ...
                <Button
                  ...
                  className="w-full bg-primary text-white font-paragraph font-semibold py-5 text-sm rounded-full hover:bg-primary-light hover:shadow-[0_6px_28px_rgba(27,58,45,0.35)] transition-all duration-300"
                >
